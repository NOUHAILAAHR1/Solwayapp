          ...
          {!isMenuOpen && (
              <div className="w-full flex flex-col items-center pt-8 text-center pb-14">
                <div>
                  ...
                  SOLDESK est une plateforme de gestion de tickets qui offre une gamme complète de fonctionnalités pour optimiser le processus de traitement des tickets et améliorer la collaboration au sein de votre équipe.</p>
                </div>
