...
const SolwayRecrute = () => {
  ...
  return (
    ...
    <div className="hidden md:block lg:hidden ipad-pro:block w-full p-8 text-center py-10">
      
        <div className="bg-[#E0AC00] shadow-xl rounded-lg mx-auto w-full p-16 text-center">
          <h1 className="font-bold text-2xl text-white mb-4">
            {t('recruitmentCase.title')} <br/> {t('recruitmentCase.question')}
          </h1>
          <p className="mt-3 text-white text-base mb-6 max-w-[32rem] mx-auto">
            {t('recruitmentCase.description')}
          </p>
